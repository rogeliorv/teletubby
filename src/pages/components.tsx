...
export default function ComponentsPage() {
  ...
  const textColor = mode === 'light' ? 'text-gray-300' : 'text-gray-600';
            ...
            <ol className='mt-8 space-y-6'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://github.com/rogeliorv'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://github.com/rogeliorv'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnderlineLink href='https://github.com/rogeliorv'>
                    Outside Links
                  </UnderlineLink>
                </div>
              </li>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink
                    variant='outline'
                    isDarkBg={mode === 'dark'}
                    href='https://github.com/rogeliorv'
                  >
                    Outline Variant
                  </ButtonLink>
                  <ButtonLink
